          ...
          <div className="text-container">
            ...
            <ul>
              <li className="li-formations">
                - Bonne nuit les petits, Accompagnement normal et problématique
                du coucher et du sommeil chez l’enfant - Formation en e-learning
              ...
              <li className="li-formations">
                - La guidance parentale de type Barkley - Formation en
                distanciel (Go élan) - Juin 2024
              </li>
              <li className="li-formations">
                - Développer et accompagner les habiletés parentales : des
                outils pour la régulation de l'attention des émotions et des
