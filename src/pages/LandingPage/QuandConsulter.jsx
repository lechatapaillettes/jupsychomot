          ...
          <div className="text-container">
            ...
            <ul>
              <li className="li-qd-consulter">
                - Éducation psychomotrice = soutien à la mise en place de
                piliers solides pour une bonne intégration des fonctions
                psychomotrices Soutien à la parentalité, éveil psychomoteur du
                tout-petit
              </li>
              <li className="li-qd-consulter">
                - Rééducation psychomotrice = action sur un/des piliers ou leurs
                liens pour les renforcer et atténuer des difficultés du
                quotidien Rééducation de l’écriture, apprentissage de nouvelles
                praxies, gestion de l’impulsivité, …
              </li>
              <li className="li-qd-consulter">
                - Thérapie psychomotrice = trouver un équilibre entre les
                piliers pour favoriser un bien être global Gestion émotionnelle,
                compensations de spécificités sensorielles, conscience
                corporelle…
              </li>
            </ul>
            <p className="text-qd-consulter">
              ...
              sont ensuite déterminés en accord avec le patient, sa famille et
              les besoins rencontrés au quotidien.
            </p>
            <p className="text-qd-consulter">
            ...
            <h3 className="text-qd-consulter h3-qd-consulter">
              Méthodes utilisées :
            </h3>
            <ul>
              <li className="li-qd-consulter">
